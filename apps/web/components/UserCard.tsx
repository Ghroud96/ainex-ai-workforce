...
export default function UserCard({ user }: { user: EnterpriseUser }) {
  ...
  return (
    <div className="flex flex-col rounded-xl bg-slate-900 p-6">
      ...
      <div className="mt-4 space-y-1 border-t border-slate-800 pt-4 text-sm text-slate-400">
      ...
      <div className="mt-4 border-t border-slate-800 pt-4">
        <p className="mb-2 text-xs font-medium tracking-wide text-slate-500 uppercase">Can Execute</p>
