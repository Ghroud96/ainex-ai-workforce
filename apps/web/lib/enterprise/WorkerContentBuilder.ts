  ...
  switch (role.slug) {
    case "executive": {
      ...
      return {
        ...
        successMetric: "Measured by how early risks and opportunities are surfaced to leadership relative to when they'd otherwise appear in a routine report.",
    ...
    case "sales": {
      ...
      return {
        ...
        successMetric: "Measured by how many at-risk accounts are re-engaged before they go cold, and how quickly a follow-up turns into a confirmed order.",
    ...
    case "finance": {
      ...
      return {
        ...
        successMetric: "Measured by how early overdue invoices and cash-flow risk are caught relative to when they'd otherwise surface in month-end close.",
    ...
    case "inventory": {
      ...
      if (!goodsBased) {
        return {
          ...
          successMetric: "Measured by how often a capacity bottleneck is caught before it delays delivery.",
      ...
      return {
        ...
        successMetric: "Measured by how often a stockout is caught and reordered before it affects fulfillment.",
    ...
    case "hr": {
      return {
        ...
        successMetric: "Measured by how much repetitive policy Q&A and onboarding follow-up is handled without HR staff involvement.",
    ...
    case "customer-support": {
      ...
      return {
        ...
        successMetric: "Measured by first-response time and how many tickets are resolved without escalation to a human agent.",
    ...
    case "operations": {
      return {
        ...
        successMetric: "Measured by how early a process delay or compliance gap is flagged relative to when it would otherwise affect output.",
    ...
    case "marketing": {
      ...
      return {
        ...
        successMetric: "Measured by how quickly underperforming campaigns are identified so budget can shift to what's converting.",
    ...
    case "procurement": {
      return {
        ...
        successMetric: "Measured by how far ahead of a renewal deadline a supplier or contract risk is flagged.",
    ...
    case "compliance": {
      return {
        ...
        successMetric: "Measured by how many policy gaps are caught before an external audit finds them.",
        knowledgeSources: ["Policies", "SOP"],
